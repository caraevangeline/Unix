...
start:              ; start label from where our code starts
    ...
    window_text1 db 10,'THIS IS A MINI PROJECT IN UNIX', 0
...
mov si,press_key                    ; point press_key string to source index
    ...
    ;/////////////////////////////////////////////////////////////
    ; load fourth sector into memory

    mov ah, 0x04                    ; load fourth stage to memory
    mov al, 1                       ; numbers of sectors to read into memory
    mov dl, 0x80                    ; sector read from fixed/usb disk
    mov ch, 0                       ; cylinder number
    mov dh, 0                       ; head number
    mov cl, 2                       ; sector number
    mov bx, _OS_Stage_4             ; load into es:bx segment :offset of buffer
    int 0x13                        ; disk I/O interrupt

    jmp _OS_Stage_4                 ; jump to fourth stage
...
_OS_Stage_4:
    ...
    mov si,window_text1             ; point si to window_text
    call _print_DiffColor_String
